...
function ProfileImage() {
    ...
    if (imageError) {
        return (
            <div className="relative aspect-[4/5] rounded-3xl overflow-hidden bg-gradient-to-br from-brand-charcoal to-brand-slate border border-white/10">
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                        <div className="w-32 h-32 rounded-full bg-gradient-to-br from-brand-ember to-brand-gold mx-auto mb-4 flex items-center justify-center">
                            <User className="w-16 h-16 text-white" />
                        </div>
                        <p className="text-text-secondary text-sm">Yogesh Alekari</p>
                    </div>
                </div>
    ...
    return (
        <div className="relative aspect-[4/5] rounded-3xl overflow-hidden bg-gradient-to-br from-brand-charcoal to-brand-slate border border-white/10">
            <Image
                ...
                alt="Yogesh Alekari on his KTM motorcycle"
                fill
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-xl text-text-secondary max-w-2xl mx-auto">
                        Passionate International Motorcycle Rider. Connecting people, cultures & hearts across borders.
                    </p>
                </motion.div>
