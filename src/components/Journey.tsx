...
const legs = [
    ...
    },
    {
        ...
        route: [
            "India", "Nepal", "Tibet", "China", "Kazakhstan", "Kyrgyzstan", "Uzbekistan", "Kazakhstan",
    ...
    },
    {
        ...
        route: [
            "UK", "France", "Belgium", "Netherlands", "Belgium", "France", "Spain",
            "Morocco", "Western Sahara", "Mauritania", "Senegal", "Gambia", "Guinea", "Sierra Leone",
            "Liberia", "Ivory Coast", "Ghana", "Togo", "Benin", "Nigeria", "Cameroon", "Gabon",
            "Congo", "ROC", "DRC", "Angola", "Namibia", "South Africa", "Lesotho",
            "eSwatini", "Mozambique", "Madagascar", "Mozambique", "Zimbabwe", "Zambia", "Tanzania",
            "Burundi", "Rwanda", "Uganda", "Kenya", "India"
        ],
        highlights: [
            { name: "Atlas Mountains", location: "Morocco", icon: "🏔️" },
            { name: "Sahara Desert", location: "Morocco", icon: "🐪" },
            { name: "Dakar City", location: "Senegal", icon: "🌴" },
            { name: "Belicia Cathedral", location: "ivory coast", icon: "🏛️" },
            { name: "Equator Line", location: "DRC", icon: "🏖️" },
            { name: "Congo River", location: "DRC", icon: "🌊" },
            { name: "Calandula Waterfall", location: "Angola", icon: "🏞️" },
            ...
            { name: "Serengeti National park", location: "Tanzania", icon: "🦁" },
            { name: "Masai Mara", location: "Kenya", icon: "🦓" },
            { name: "Lake Victoria", location: "Tanzania", icon: "🐟" },
            { name: "Zanzibar Tanzania", location: "Tanzania", icon: "🏝️" }
        ]
    }
];
                ...
                >
                    {legs.map((leg) => (
                        <button
                            ...
                            className={`px-6 py-3 rounded-full font-medium transition-all flex items-center gap-2 ${activeLeg === leg.id
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
                                        <div>
                                            <span className={`inline-block px-3 py-1 rounded-full text-xs font-bold mb-3 ${leg.status === "Completed"
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                                    {leg.highlights.map((item, idx) => (
                                        <motion.div
                                            ...
                                            className={`p-4 rounded-xl bg-gradient-to-br ${leg.id === 1 ? "from-green-500/20 to-emerald-500/20 border-green-500/20 hover:border-green-500/50" :
